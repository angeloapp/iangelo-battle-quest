...
export default class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(this.dimensions.statsContainer.x + this.dimensions.statsContainer.w/2, this.dimensions.statsContainer.y + 40*this.scaleValue , 'Estadísticas', {
        ...
        this.add.text(this.dimensions.statsContainer.x + this.dimensions.statsContainer.w/8, this.dimensions.statsContainer.y + 100*this.scaleValue, 'puntuación: ' + this.score , {
        ...
        this.add.text(this.dimensions.statsContainer.x + this.dimensions.statsContainer.w/8, this.dimensions.statsContainer.y + 150*this.scaleValue, 'tiempo sobrevivido: ' + this.time_survived , {
            fontFamily: '"Varela Round", sans-serif',
            fontSize: "26px",
            fill: "#FFFFFF",
            strokeThickness: 1
        ...
        this.add.text(this.dimensions.statsContainer.x + this.dimensions.statsContainer.w/8, this.dimensions.statsContainer.y + 200*this.scaleValue, 'impactos: ' + this.hits , {
            fontFamily: '"Varela Round", sans-serif',
            fontSize: "26px",
            fill: "#FFFFFF",
            strokeThickness: 1
        ...
        this.add.text(this.dimensions.playAgainButton.x, this.dimensions.playAgainButton.y , "jugar de nuevo" , {
            fontFamily: '"Varela Round", sans-serif',
            fontSize: "20px",
            fill: "#FFFFFF",
            strokeThickness: 1
        ...
        this.add.text(this.dimensions.shareButton.x, this.dimensions.shareButton.y , "compartir juego" , {
            fontFamily: '"Varela Round", sans-serif',
            fontSize: "20px",
            fill: "#FFFFFF",
            strokeThickness: 1
