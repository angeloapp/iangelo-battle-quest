...
export default class PlayScene extends Phaser.Scene {
    ...
    roomJoined = false;
    room = null;
    closingMessage = "Te desconectaste del servidor";
    ...
    connect() {
            ...
            if (message.event == "start_position") {
                ...
                if (message.dead_data.id == self.room.sessionId) {
                    ...
                    this.tweens.add({
                        ...
                        yoyo: false,
                        onComplete: function () {
                            // posición del primer elemento objetivo
        ...
        this.room.onError.add(() => {
            alert(room.sessionId + " no pudo unirse a " + room.name);
        });
    ...
    update(time, delta) {
        ...
        for (let id in this.players) {
            ...
            // Interpolar el ángulo evitando el problema entre positivo y negativo 
